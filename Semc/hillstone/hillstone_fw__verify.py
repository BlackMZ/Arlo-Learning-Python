...
class PamConnector:
    ...
    def verify_login(self):
        ...
        try:
            ...
            time.sleep(1)
            # //*[@id="mainContent"]/table/tbody/tr/td[2]/table/tbody/tr[5]/td[3]/input
            self.driver.find_element_by_xpath("//*[@id='mainContent']/table/tbody/tr/td[2]/table/tbody/tr[5]/td[3]/input").send_keys(self.pwd)
            time.sleep(1)
            self.driver.find_element_by_id("login_button").click()
            time.sleep(5)
            result = self.driver.find_element_by_class_name("banner_info").is_enabled()
            if result:
                print("result=" + "true")
            else:
                print("result=" + "false")
