...
class PamConnector:
    ...
    def discover_account(self):
        ...
        try:
            ...
            time.sleep(2)
            check = self.driver.find_element_by_id("privacy").is_selected()
            if check is False:
            ...
            if self.driver.find_element_by_id("gcs_user_area").is_enabled():
                time.sleep(1)
                self.driver.find_element_by_xpath("//span[contains(.,'系统设置')]").click()
                time.sleep(3)
                ...
                # //*[@id="ext-gen82"]/div[4]/table/tbody/tr/td[2]/div/a
                discover_username_elements = self.driver.find_elements_by_xpath(
                    "//table/tbody/tr/td[2]/div/a")
