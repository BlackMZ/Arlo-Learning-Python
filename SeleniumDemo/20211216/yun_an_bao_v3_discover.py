    ...
    def discover_account(self):
        ...
        try:
            ...
            if self.driver.find_element_by_id("guide-header-personal-centre").is_enabled():
                ...
                time.sleep(1)
                self.driver.find_element_by_xpath("//span[contains(.,'用户')]").click()
                time.sleep(1)
                self.driver.find_element_by_xpath("//div/div[1]/div[2]/div/ul/div/li[3]/ul/li[1]").click()
                # self.driver.find_element_by_xpath("//span[contains(.,'用户管理')]").click()
                time.sleep(1)
                # //*[@id="user-root"]/div/div[3]/table/tbody/tr/td[2]
