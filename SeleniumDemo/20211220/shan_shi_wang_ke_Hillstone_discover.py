    ...
    def discover_account(self):
        ...
        try:
            ...
            if self.driver.find_element(By.ID, "ext-gen1100").is_enabled():
                ...
                self.driver.find_element(By.XPATH, "(//div[@id=\'menu_javascript:;\']/span)[5]").click()
                time.sleep(1)
                self.driver.find_element(By.LINK_TEXT, "设备管理").click()
                time.sleep(1)
                self.driver.find_element(By.LINK_TEXT, "管理员").click()
                time.sleep(1)
                discover_username_elements = self.driver.find_elements(
                    By.XPATH, "//div[3]/div/table/tbody/tr/td[2]/div")
                # discover_username = []
