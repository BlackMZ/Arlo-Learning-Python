    ...
    def verify_modify_pwd(self):
        ...
        try:
            ...
            self.driver.find_element(By.XPATH,
                                     "//*[@id='root']/div/section/div[7]/div/div/form/div[3]/div[2]/button/span").click()
            time.sleep(1)
            if self.driver.find_element(By.XPATH, "//*[@id='root']/header/div/span").is_enabled():
                self.driver.find_element(By.XPATH, "//*[@id='root']/header/div/div[1]").click()
                time.sleep(2)
                self.driver.find_element(By.CSS_SELECTOR,
                                         ".next-menu > .next-menu-item:nth-child(2) .next-menu-item-text").click()
                time.sleep(1)
                new_pwd1 = self.driver.find_element(By.ID, "password").send_keys(
                    self.new_pwd)
                time.sleep(1)
                new_pwd2 = self.driver.find_element(By.ID, "rePassword").send_keys(
                    self.new_pwd)
                time.sleep(1)
