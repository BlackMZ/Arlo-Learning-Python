    ...
    def verify_modify_pwd(self):
        ...
        try:
            ...
            if self.driver.find_element(By.LINK_TEXT, "地盘").is_enabled():
                ...
                self.driver.find_element(By.CSS_SELECTOR, ".dropdown-toggle span").click()
                time.sleep(2)
                self.driver.find_element(By.LINK_TEXT, "修改密码").click()
                time.sleep(1)
                self.driver.switch_to.frame(1)
                self.driver.find_element(By.ID, "originalPassword").send_keys(self.pwd)
                time.sleep(1)
                self.driver.find_element(By.ID, "password1").send_keys(self.new_pwd)
                time.sleep(1)
                self.driver.find_element(By.ID, "password2").send_keys(self.new_pwd)
                time.sleep(1)
                self.driver.find_element(By.ID, "submit").click()
                time.sleep(1)
                print("result=" + "true")
